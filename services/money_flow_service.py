...
SECTOR_MONEY_FLOW_DATA: List[Dict[str, Any]] = [
    {
        ...
        "status_color": "#2ECC71",
        "top_stocks": ["VHM", "VIC", "VRE", "KDH", "NLG", "DXG", "DIG", "PDR", "NVL", "KBC", "IDC", "BCM", "TCH", "CEO"],
    ...
    },
    {
        ...
        "status_color": "#2ECC71",
        "top_stocks": ["FPT", "CMG", "CTR", "ELC", "FOX", "VGI"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#2ECC71",
        "top_stocks": ["SSI", "VCI", "HCM", "VND", "MBS", "FTS", "BSI", "CTS", "VDS", "ORS", "SHS"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#00ADB5",
        "top_stocks": ["VCG", "HHV", "C4G", "CTD", "HBC", "FCN", "LCG", "CII", "DPG"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#00ADB5",
        "top_stocks": ["PC1", "GEG", "HDG", "REE", "POW", "NT2", "QTP", "VSH"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#F39C12",
        "top_stocks": ["VCB", "BID", "CTG", "TCB", "MBB", "ACB", "VPB", "HDB", "STB", "LPB", "SHB", "VIB", "TPB", "MSB", "OCB", "SSB", "EIB"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#F39C12",
        "top_stocks": ["MWG", "PNJ", "MSN", "VNM", "FRT", "DGW", "SAB", "KDC", "VHC", "ANV", "DBC", "BAF", "QNS"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#E74C3C",
        "top_stocks": ["HPG", "HSG", "NKG", "KSB", "VGS", "HT1", "BCC", "VCS", "BMP", "NTP"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#E74C3C",
        "top_stocks": ["GAS", "PVD", "PVS", "BSR", "PLX", "PVT"],
        "is_live_computed": False,
    ...
    },
    {
        ...
        "status_color": "#E74C3C",
        "top_stocks": ["DGC", "DCM", "DPM", "CSV", "BFC", "LAS", "PHR", "DPR", "GVR"],
        "is_live_computed": False,
